...
// every mutation is one git commit (delete = recoverable removal). Mirrors the server's
// git-store semantics (git grep ranking, frontmatter passthrough, str_replace contract).

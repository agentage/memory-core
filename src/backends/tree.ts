// Folder-tree builder, ported from agentage/web memory-mcp git-store.ts (the list
// algorithm). Operates on a flat path list (from `git ls-files`) instead of `ls-tree`.

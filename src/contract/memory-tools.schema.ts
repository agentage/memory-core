// VENDORED VERBATIM from agentage/web packages/memory-mcp/src/schemas/memory-tools.schema.ts.
// The frozen 6-tool surface (api-contract AC2). Changing any name, shape, or the set
// is an ADR-gated breaking change, enforced by the .mcpc.json snapshot. Re-sync on
// contract change; do not edit here independently.

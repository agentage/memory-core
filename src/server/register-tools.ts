...
import { MEMORY_TOOLS } from '../contract/memory-tools.schema.js';
import type { EditInput, ListQuery, SearchQuery, WriteInput } from '../contract/types.js';
import type { Router } from '../router/router.js';
import { UnknownVaultError } from '../router/router.js';
import {
  renderDelete,
  renderEdit,
  renderList,
...
// Register the frozen 6-tool surface onto the federated router. Output mirrors the
// server: write/edit return {path,updated} (rev stripped, T05); errors are isError.

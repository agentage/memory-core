// VENDORED from agentage/web memory-mcp tools/render-markdown.ts. The model reads
// content[].text; we render lean per-tool markdown there (never a JSON dump) while
// structuredContent carries the typed object. Re-sync on contract change.

import { serializeDoc } from '../contract/memory-doc.js';
import type {
  ListQuery,
  ListResult,
  MemoryView,

...
// TC10 - round-trip through MCP tools/call.
describe('TC10 tools/call round-trip', () => {
...
// TC11 - @vault routing + bare path -> default.
describe('TC11 routing', () => {
...
// TC12 - unknown vault -> isError (no crash).
describe('TC12 unknown vault', () => {
...
// TC13 - search/list fan out across surfaced vaults and tag each result with @vault.
describe('TC13 fan-out tagging', () => {
...
// TC14 - scope surfacing.
describe('TC14 scope surfacing', () => {
...
// TC15 - write/edit tool output omits rev (response-minimization, matches the server).
describe('TC15 write/edit omit rev', () => {
